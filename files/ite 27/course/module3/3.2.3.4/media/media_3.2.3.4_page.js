(slideViewDidLoad = function(_container, _id) {
    btnXPosArr = [216.85, 295.8, 349.4, 280.95, 359.45, 452.35, 212.5, 507.65];
    btnYPosArr = [188.05, 110.3, 317.35, 317.35, 188.05, 159.85, 317.35, 279.8];
    btnNameArr = ['btn02', 'btn01', 'btn06', 'btn05', 'btn03', 'btn07', 'btn04', 'btn08'];
    buttonArr = [];
    buttonClickArr = [];
    buttonOverArr = [];
    bubbleArr = [];
    var lastBtnClick;
    textBoxProps = ['', 'ID_bodyTxt01', 219, 180, 207, 128];
    for (var i = 0; i < btnXPosArr.length; i++) {
        ...
        tBox = getCJSElement('TEXTBOX', { subType:"CLOSABLE",x: textBoxProps[2], y: textBoxProps[3], width: textBoxProps[4], height: textBoxProps[5], size: 11, titleId: tBoxTitle, bodyId: tBoxBody });
        bubbleArr[i] = tBox;
