...
{
  btnXPosArr=[134.3,134.3,134.3,134.3];
  btnYPosArr=[151.35,201.35,251.35,301.35];
buttonArr=[];
buttonClickArr=[];
buttonOverArr=[];
bubbleArr=[];
...
var btn2 = getCJSElement("TEXTBOX",{x:396.8,y:120.9,width:230,height:250,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
