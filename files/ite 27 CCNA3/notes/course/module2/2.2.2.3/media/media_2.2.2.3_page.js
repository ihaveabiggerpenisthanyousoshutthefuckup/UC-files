...
(slideViewDidLoad = function(_container,_id)
{
	...
	if(_id > 0)
	{
		...
		rh.x = 392;
		rh.y = 315;
		var bb_chk = getCJSElement("BLUE_BUTTON",{x:48,y:373.8,width:100,height:21,size:11,id:("bb_chk"+parseInt(_id)),compId:"ID_s"+parseInt(_id)+"_check",callback:checkAns});
		var bb_rst = getCJSElement("BLUE_BUTTON",{x:183,y:373.8,width:100,height:21,id:"bb_rst"+parseInt(_id),compId:"ID_s"+parseInt(_id)+"_reset",callback:reset});
		...
		var feedback = getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:"367",y:"107",width:"300",height:"180",titleId:"ID_blankTitle",bodyId:"ID_blankBody",visible:"0"});
		var correct_img = getCJSElement("IMAGE",{src:"correct.png",x:"0",y:"332",width:"12",height:"12"});
		var wrong_img = getCJSElement("IMAGE",{src:"wrong.png",x:"275",y:"332",width:"12",height:"12"});
