...
(McTable = function(o, xmlNode) {
    ...
    var loaded = function(_obj) {
        ...
        for(var k = 0; k<hitBtnArr.length; k++) {
          for(var a = hitBtnArr[k].length; a > 0; a--) {
            ...
            divElement.id = '#colBtnHolder'+(k+1)+(a-1);
            ...
            divElement.setAttribute('aria-label', 'Check here button');
            divElement.onclick = function(e) {
            var rowNum = this.getAttribute('data-rownum');
            var btn = hitBtnArr[rowNum-1][this.id.substr(this.id.length - 1)]._btn;
            btn.onClick()
            }
    ...
    t.onoffClicked = function(_btn, _j, _t) {
      console.log(_btn,"ghghgh", _j,"hjgjgjghj", _t);
    ...
    $(xmlNode).find('subelement').each(function() {
        ...
        switch (type) {
            ...
            case "QUESTION":
                ...
                var temp = "<label><select class='" + "select" + "' aria-label='Select the answer' id='" + count_dropdown + "' style = float:left;width:" + 130 + "px>";
                ...
                temp += "</select></label><img src='../../../common/images/wrong-mctable.png' alt='Incorrect icon' id='highlight_" + count_dropdown + "' style=width:0px;height:0px;float:right;margin-left:5px;></img>"
        ...
        if (o.div == "slide_1") {
            for (i = 0; i < 7; i++) {
                if (givenAnswer[i] != 1) {
                    ...
                    $("#highlight_" + i).attr("alt", "Incorrect icon")
                    wrong = true
                } else {
                    var temp = 7;
                    temp -= 1;
                    ...
                    $("#highlight_" + i).attr("alt", "Correct icon")
                }
            }
        } else if (o.div == "slide_2") {
