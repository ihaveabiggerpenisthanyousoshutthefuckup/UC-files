...
{
  btnXPosArr=[85,349.35,88.4,350.65];
  btnYPosArr=[50,50,263.05,263.05];
buttonArr=[];
buttonClickArr=[];
buttonOverArr=[];
bubbleArr=[];
...
var btn2 = getCJSElement("TEXTBOX",{subType:"CLOSABLE",x:198,y:124.2,width:281,height:131,size:11,titleId:bubbleTitleArr[i],bodyId:bubbleTextArr[i]});
